...
wget -O addgrpc "https://raw.githubusercontent.com/Mr-Kenyut/AutoScript/main/grpc/addgrpc.sh"
wget -O delgrpc "https://raw.githubusercontent.com/Mr-Kenyut/AutoScript/main/grpc/delgrpc.sh"
wget -O cekgrpc "https://raw.githubusercontent.com/Mr-Kenyut/AutoScript/main/grpc/cekgrpc.sh"
wget -O renewgrpc "https://raw.githubusercontent.com/Mr-Kenyut/AutoScript/main/grpc/renewgrpc.sh"
chmod +x addgrpc
sed -i -e 's/\r$//' addgrpc
chmod +x delgrpc
sed -i -e 's/\r$//' delgrpc
